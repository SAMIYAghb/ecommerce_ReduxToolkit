...
const CartModal = ({carts}) => {
  return (
    <div className='cart-modal'>
      <h5 className='cart-modal-title fw-5 fs-15 font-manrope text-center'>Recenlty Added</h5>
      {
        (carts?.length > 0) ? (
          <div className='cart-modal-list grid'>
            ...
            <Link to ='/cart' className='view-cart-btn bg-orange fs-15 font-manrope text-center'>view my shopping cart</Link>
          </div>) : (
